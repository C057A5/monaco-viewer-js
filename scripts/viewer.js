...
//TODO: attach viewer based on contentType or extension, not on all documents having a pre as the first tag inside body
//TODO: attach viewer on document start and render progressively

if (document.querySelector("body>pre:first-child")) {
